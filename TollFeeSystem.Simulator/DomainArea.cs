...
namespace TollFeeSystem.Simulator
{
    public class DomainArea
    {
        ...
        public void Run()
        {
            ...
            _portals[5].VehicleInteraction(vehicleRegistry[2], DateTime.Parse("2022-05-22T16:08:00"));
            ...
            _portals[7].VehicleInteraction(vehicleRegistry[0], DateTime.Parse("2022-05-23T12:56:00"));
